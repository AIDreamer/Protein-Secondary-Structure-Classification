...
% Calculate delta
delta3 = -(groundTruth - a3);
delta2 = softmaxTheta' * delta3 .* dsigmoid(a2);
% Calculate nabla
nablaW1 = delta2 * a1';
nablab1 = delta2;
% Calculate the desired partial derivatives
softmaxThetaGrad = 1 / m * (a2*delta3')';
