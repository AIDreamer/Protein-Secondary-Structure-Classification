function [Wc, Wd, bc] = cnnParamsToStack(theta,inputLength,filterLength,...
...
convolvedDim = inputLength - filterLength + 1;
hiddenSize = convolvedDim*numFilters;

%% Reshape theta
indS = 1;
indE = filterLength*21*numFilters;
Wc = reshape(theta(indS:indE),21,filterLength,numFilters);
indS = indE+1;
