...
hiddenSizeL2 = 100;       % number of hidden units of layer 1
...
figure(2);
displayProteinFeatures(features2Visualize', 1, 1, 20, 0, windowSize, 21);
...
% Prediction for the training set before fine-tuning
% --------------------------------------------------
...
for proteinNum = 1:numProteins
    % For each protein, initialize test data and test labels
...
% Prediction for the training set after fine-tuning
% -------------------------------------------------
...
% Prediction for the testing set before fine-tuning
% --------------------------------------------------
...
% Prediction for the testing set after fine-tuning
% --------------------------------------------------
