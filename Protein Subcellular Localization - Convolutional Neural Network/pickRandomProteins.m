function [trainProteins,testProteins] = pickRandomProteins( proteinTable, numProteins )
...
trainProteins = cell(3,0);
testProteins = cell(3,0);
...
while checkNumLabels(trainProteins) == 0
    ...
    [trainProteins,~] = datasample(testProteins,numProteins,2,'Replace',false);
end
