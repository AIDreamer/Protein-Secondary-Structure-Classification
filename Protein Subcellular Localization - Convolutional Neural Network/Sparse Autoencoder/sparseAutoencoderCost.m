function [cost,grad] = sparseAutoencoderCost(theta, visibleSize, hiddenSize, ...
                                             lambda, sparsityParam, beta, noisyData, trainData)
...
m = size(trainData,2); % size of training set
...
squarederror = 1 / (2 * m) * sum(sum((a3 - trainData) .^ 2));
...
y = trainData; % We wish to reconstruct the input as perfectly as possible.
