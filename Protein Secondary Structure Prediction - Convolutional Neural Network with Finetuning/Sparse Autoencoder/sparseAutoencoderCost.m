function [cost,grad] = sparseAutoencoderCost(theta, visibleSize, hiddenSize, ...
                                             lambda, sparsityParam, beta, noisyData, sampleData)
...
m = size(noisyData,2); % size of training set
...
a1 = noisyData; % First layer activation is the input itself
...
squarederror = 1 / (2 * m) * sum(sum((a3 - sampleData) .^ 2));
...
y = sampleData; % We wish to reconstruct the input as perfectly as possible.
